...
{
    public partial class FrmVariable6 : Form
    {
        public FrmVariable6()
        {
            InitializeComponent();
        ...
        private DataTable getDataReport(string jenis)
        {
            ...
            //             SUM ( inacbg.TARIF_RS) AS Total_Tarif
            //            FROM
            ...
            string query = @"SELECT CASE
                            ...
                            SUM ( inacbg.TARIF_RS) AS Total_Tarif FROM  INACBG_RAW_DATA inacbg
                            WHERE
	                         ptd = @jenisRawat
        ...
        private void dgPiutang_AutoGeneratingColumn(object sender, Syncfusion.WinForms.DataGrid.Events.AutoGeneratingColumnArgs e)
        {
            ...
            if (e.Column.MappingName == "Total_Tarif")
            {
                e.Column.HeaderText = "Total Tarif";
                e.Column.Width = 180;
                e.Column.AllowFiltering = true;
