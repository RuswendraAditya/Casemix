...
namespace Casemix.Forms.Analisa_BPJS
{
    ...
    {
        FrmAnalisaPerCodingDtl frmAnalisaPerCodingDtl;
        ...
        private void TableControl_CellClick(object sender, GridCellClickEventArgs e)
        {
            ...
            if (pivotGridControlBase != null)
            {
                ...
                if (row != 0)
                {
                    ...
                    if (frmAnalisaPerCodingDtl == null)
                    {
                        frmAnalisaPerCodingDtl = new FrmAnalisaPerCodingDtl();
                        frmAnalisaPerCodingDtl.rawValue = rawItems;
                        frmAnalisaPerCodingDtl.Show();
                        frmAnalisaPerCodingDtl.Closed += (s, ea) => frmAnalisaPerCodingDtl = null;
                    }
